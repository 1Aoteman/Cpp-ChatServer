...
public:
    ...
    void setupUi(QDialog *AuthenFriend)
    {
        ...
        AuthenFriend->resize(369, 602);
        verticalLayout = new QVBoxLayout(AuthenFriend);
        verticalLayout->setObjectName("verticalLayout");
        verticalSpacer = new QSpacerItem(20, 279, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        scrollcontent->setGeometry(QRect(0, 0, 349, 498));
